import numpy as np
from pybullet_tools.more_utils import load_env, get_collision_fn_PR2, execute_trajectory, draw_sphere_marker, draw_line, get_joint_axis, get_joint_axis, get_joint_position
...
def main(screenshot=False):
    ...
    robots, obstacles = load_env('scenes/pr2table.json')
    ...
    """
    print("Example joint axis and position in world frame:")
    wait_for_user()
    jointname = 'l_shoulder_pan_joint'
    jointid = joint_from_name(PR2, jointname) 
    print("Joint ", jointname, " axis:", get_joint_axis(PR2, jointid))
    print("Joint ", jointname, " position:", get_joint_position(PR2, jointid))
    print("=======================================")
